namespace WebAPIDemo.Models.Repositories
{
    public class ShirtRepository
    {
        ...
        {
            new Shirt {ShirtId =1, Brand = "Splash", Color = "Balck", Gender = "Men", Price = 4.5, Size = 10},
            new Shirt {ShirtId =2, Brand = "H&M", Color = "Green", Gender = "Women", Price = 10, Size = 9},
            new Shirt {ShirtId =3, Brand = "Bershka", Color = "Red", Gender = "Men", Price = 14, Size = 12},
            new Shirt {ShirtId =4, Brand = "Zara", Color = "Grey", Gender = "Women", Price = 20.5, Size = 15}
        };
